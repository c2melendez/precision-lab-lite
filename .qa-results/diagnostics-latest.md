...
added 454 packages, and audited 455 packages in 5s
...
[1m[7m[36m RUN [39m[27m[22m [36mv2.1.9 [39m[90m/home/runner/work/precision-lab-lite/precision-lab-lite[39m
 ...
 [32m✓[39m tests/parsing.test.ts [2m([22m[2m51 tests[22m[2m)[22m[90m 43[2mms[22m[39m
 [32m✓[39m tests/statFunctions.test.ts [2m([22m[2m29 tests[22m[2m)[22m[90m 39[2mms[22m[39m
 [32m✓[39m tests/graphing.test.ts [2m([22m[2m23 tests[22m[2m)[22m[33m 328[2mms[22m[39m
 [32m✓[39m tests/matrixOps.test.ts [2m([22m[2m18 tests[22m[2m)[22m[90m 15[2mms[22m[39m
 [32m✓[39m tests/percentile.test.ts [2m([22m[2m18 tests[22m[2m)[22m[90m 18[2mms[22m[39m
 [32m✓[39m tests/calculus.test.ts [2m([22m[2m25 tests[22m[2m)[22m[90m 273[2mms[22m[39m
 [32m✓[39m tests/unitConversion.test.ts [2m([22m[2m22 tests[22m[2m)[22m[90m 10[2mms[22m[39m
 [32m✓[39m tests/exhaustive-module10-keyboard-parity.test.ts [2m([22m[2m31 tests[22m[2m)[22m[90m 50[2mms[22m[39m
 [32m✓[39m tests/useRecentKeysStore.test.ts [2m([22m[2m7 tests[22m[2m)[22m[90m 10[2mms[22m[39m
 [32m✓[39m tests/distributions.test.ts [2m([22m[2m14 tests[22m[2m)[22m[90m 17[2mms[22m[39m
 [32m✓[39m tests/exhaustive-module02-algebra.test.ts [2m([22m[2m18 tests[22m[2m)[22m[33m 302[2mms[22m[39m
 [32m✓[39m tests/exhaustive-module07-statistics.test.ts [2m([22m[2m6 tests[22m[2m)[22m[90m 19[2mms[22m[39m
 [32m✓[39m tests/eigenOps.test.ts [2m([22m[2m7 tests[22m[2m)[22m[33m 1540[2mms[22m[39m
   [33m[2m✓[22m[39m computeEigenvalues[2m > [22m3x3 diagonal diag(2,3,5): eigenvalores exactos 2,3,5, eigenvectores = base estándar [33m410[2mms[22m[39m
   [33m[2m✓[22m[39m computeEigenvalues[2m > [22m3x3 tridiagonal [[2,1,0],[1,2,1],[0,1,2]]: eigenvalores 2, 2-√2, 2+√2 — mismo caso verificado en K0 contra el paquete real [33m523[2mms[22m[39m
 [32m✓[39m tests/keyboardParityV5.test.ts [2m([22m[2m4 tests[22m[2m)[22m[90m 27[2mms[22m[39m
 [32m✓[39m tests/exhaustive-module06-matrices.test.ts [2m([22m[2m9 tests[22m[2m)[22m[33m 727[2mms[22m[39m
   [33m[2m✓[22m[39m Suite exhaustiva original — Módulo 6: Matrices[2m > [22meigen 3x3 diagonal 2,3,5 [33m487[2mms[22m[39m
 [32m✓[39m tests/keyboardEngineParityV5.test.ts [2m([22m[2m33 tests[22m[2m)[22m[90m 23[2mms[22m[39m
 [32m✓[39m tests/exhaustive-module09-graphing.test.ts [2m([22m[2m6 tests[22m[2m)[22m[90m 51[2mms[22m[39m
 [32m✓[39m tests/keyboardInventoryV5.test.ts [2m([22m[2m5 tests[22m[2m)[22m[90m 38[2mms[22m[39m
 [32m✓[39m tests/exhaustive-module10-keyboard-inventory.test.ts [2m([22m[2m4 tests[22m[2m)[22m[90m 35[2mms[22m[39m
 [32m✓[39m tests/exhaustive-module08-units.test.ts [2m([22m[2m5 tests[22m[2m)[22m[90m 7[2mms[22m[39m
 [32m✓[39m tests/inequality.test.ts [2m([22m[2m11 tests[22m[2m)[22m[33m 371[2mms[22m[39m
 [32m✓[39m tests/exhaustive-module03-calculus.test.ts [2m([22m[2m10 tests[22m[2m)[22m[90m 128[2mms[22m[39m
 [32m✓[39m tests/linearInequalitySystem.test.ts [2m([22m[2m5 tests[22m[2m)[22m[90m 6[2mms[22m[39m
 [32m✓[39m tests/exhaustive-module04-ode.test.ts [2m([22m[2m7 tests[22m[2m)[22m[90m 179[2mms[22m[39m
 [31m❯[39m tests/exhaustive-module01-trigonometry.test.ts [2m([22m[2m30 tests[22m[2m | [22m[31m1 failed[39m[2m)[22m[90m 35[2mms[22m[39m
[31m   [31m×[31m Suite exhaustiva original — Módulo 1: Trigonometría[2m > [22msec(pi/2) no produce un valor finito silencioso[90m 12[2mms[22m[31m[39m
...
[22m[39mnone: "none"
 ...
 [32m✓[39m tests/linearSystem5x5.test.ts [2m([22m[2m3 tests[22m[2m)[22m[90m 7[2mms[22m[39m
 [32m✓[39m tests/linearSystem.test.ts [2m([22m[2m5 tests[22m[2m)[22m[90m 65[2mms[22m[39m
 [32m✓[39m tests/systemSplit.test.ts [2m([22m[2m6 tests[22m[2m)[22m[90m 13[2mms[22m[39m
 [32m✓[39m tests/exhaustive-module05-complex.test.ts [2m([22m[2m6 tests[22m[2m)[22m[90m 62[2mms[22m[39m
...
[22m[39macoth(3) = [33m0.34657359027997264[39m
 ...
 [32m✓[39m tests/reciprocalHyperbolicInverses.test.ts [2m([22m[2m3 tests[22m[2m)[22m[90m 9[2mms[22m[39m
...
[22m[39m45°30′15″ => ((45+30/60+15/3600)*pi/180) = 0.794198... esperado: [33m0.7941975317095864[39m
 ...
 [32m✓[39m tests/degreesNotation.test.ts [2m([22m[2m3 tests[22m[2m)[22m[90m 28[2mms[22m[39m
 [32m✓[39m tests/cbrtSign.test.ts [2m([22m[2m5 tests[22m[2m)[22m[90m 11[2mms[22m[39m
 [32m✓[39m tests/algebra.test.ts [2m([22m[2m3 tests[22m[2m)[22m[90m 104[2mms[22m[39m
 [32m✓[39m tests/exhaustive-module11-layout-responsive.test.ts [2m([22m[2m2 tests[22m[2m)[22m[90m 5[2mms[22m[39m
 [32m✓[39m tests/plusMinus.test.ts [2m([22m[2m3 tests[22m[2m)[22m[90m 9[2mms[22m[39m
...
[2m      Tests [22m [1m[31m1 failed[39m[22m[2m | [22m[1m[32m436 passed[39m[22m[90m (437)[39m
[2m   Start at [22m 04:59:15
[2m   Duration [22m 7.44s[2m (transform 1.01s, setup 0ms, collect 5.74s, tests 4.60s, environment 10ms, prepare 4.01s)[22m
...
[2mdist/[22m[2massets/[22m[32mcompute.worker-VrUrTpra.js                [39m[1m[2m  427.53 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[35mindex-bhCVTFha.css                        [39m[1m[2m   57.97 kB[22m[1m[22m[2m │ gzip:  14.13 kB[22m
[2mdist/[22m[2massets/[22m[36mindex-Jt_TayTg.js                         [39m[1m[33m1,451.21 kB[39m[22m[2m │ gzip: 393.08 kB[22m
[33m
...
precache  [32m31 entries[39m [2m(2196.22 KiB)[22m
files generated
  [2mdist/sw.js[22m
