...
import { convert } from "../src/engine/unitConversion";
...
// Este archivo es deliberadamente equivalente al de precision-lab
// (frontend/src/__tests__/unitConversion.test.ts) — mismos casos, mismos
// valores esperados, porque unitConversion.ts es byte-idéntico entre
// ambos repos (confirmado con diff vacío en el cierre del módulo).
